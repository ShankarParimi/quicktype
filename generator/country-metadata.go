...
func NewCountryMetadata(metadataInformation [object Object]) *CountryMetadata {
...
func NewMetadataInformation(alpha_3 string, continentCode string, continentName string, countryName string, currency [],string, defaultLocale string, dialCode string, flag string, locales []Locales, numericCode string, sovereignty string, timezoneOfCapital string, timezones map[string]Timezones) *MetadataInformation {
